	...
	*/
	cMemory::cMemory()
	{
		...
		*/
		...
		ADDRESS_SENDTOSERVER = Scan(&MODULE_ENGINE, (PBYTE)"\x6A\xFF\x68\x00\x00\x00\x00\x64\xA1\x00\x00\x00\x00\x50\x83\xEC\x2C", Strings->MASK_SENDTOSERVER);//xxx????xx????xxxx
