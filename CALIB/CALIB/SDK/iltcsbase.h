...
Used for: Object.
*/
	virtual bool IntersectSegment(unsigned int Query, unsigned int *pInfo) = 0;
...
Used for: Object.
*/
	virtual bool IntersectSegmentAgainst(unsigned int Query, unsigned int *pInfo, HOBJECT hObject) = 0;
